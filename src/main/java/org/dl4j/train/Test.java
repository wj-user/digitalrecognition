...
public class Test implements InitializingBean {
	...
	public static void main(String[] args) throws Exception {
		net = ModelSerializer.restoreMultiLayerNetwork(new File("/Users/weijian/Downloads/sem2/cloud computing/project/dl4j-demo/digitalrecognition/src/main/webapp/model/minist-model2.zip"));
		//4
